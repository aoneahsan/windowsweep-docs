    ...
    {JSON.stringify(
      {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "No. The source contains no HTTP or socket call; the self-test greps for them. --report-issue opens your browser at a pre-filled GitHub page after you confirm, and you submit it yourself."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Caches regenerate; an undo copy would consume the disk you are trying to free. Personal files - sections 18, 19 and 23 - go to the Recycle Bin instead, which is Windows' undo. Every deletion is recorded in the session log."
              }
            },
            {
              "@type": "Question",
